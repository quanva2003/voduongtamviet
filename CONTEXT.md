...
## 5. Color Palette — Classic Wabi (Washi · Ink · Seal)
...
/* ACCENT */
--color-shu-seal:        #8b1a14;   /* dark: #c43d36  — đỏ ấn triện */
...
--color-danger:          #8b1a14;   /* = shu-seal */
--color-warning:         #b8843d;
--color-info:            #4a6478;
```

**Quy tắc dùng màu đỏ Shu** — chỉ ở:
...
**Không dùng** cho: button background lớn, section background, body text, border thường.
